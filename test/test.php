...
<html lang="en">
    ...
    <body class="boady" >
        ...
        <div class="size1 flex-w flex-col-c-sb p-l-15 p-r-15 p-t-55 p-b-35 respon1 bag" style="position: absolute;">
            <form name="formulario_respuestas" id="formulario_respuestas" method="POST" >   
                <input type="hidden" name="pregunta[]" id="pregunta[]"> 
                <input type="hidden" name="punto[]" id="punto[]">

                <!-- Pregunta 1  -->
                <div class="flex-col-c p-t-50 p-b-50 pregunta-1" style=" ">
                ...
                <div class="flex-col-c p-t-50 p-b-50 pregunta-60" style="display: none;">
                    <h3 class="l1-txt1 txt-center p-b-10" style="">
                        Test Ice de Baron
                    </h3>
                ...
                <div class="wsize1 m-lr-auto" id="guardando-respuestas" style="background: white; border-radius: 10px; display: none;">
                    <h3 class="m1-txt1 txt-center   p-t-20" style="margin: 50px;">
                        <span class="bor1 p-b-6"  >Guardando tus respuestas</span>
                    </h3>

                    <div class="m1-txt2 txt-center ">
                            <img src="images/cargando.gif" alt="" width="300">
                    </div>                                           
