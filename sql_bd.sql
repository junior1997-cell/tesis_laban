...
ALTER SCHEMA `tesis_laban`  DEFAULT CHARACTER SET utf8  DEFAULT COLLATE utf8_general_ci ;

CREATE TABLE IF NOT EXISTS tesis_laban.departamento (
...
CREATE TABLE IF NOT EXISTS tesis_laban.provincia (
  ...
  CONSTRAINT `fk_provincia_departamento1`
    ...
    REFERENCES `tesis_laban`.`departamento` (`id_departamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS tesis_laban.distrito (
  `id_distrito` INT(11) NOT NULL,
  `nombre` VARCHAR(45) NULL DEFAULT NULL,
  `iddepartamento` INT(11) NOT NULL,
  `idprovincia` INT(11) NOT NULL,
  PRIMARY KEY (`id_distrito`),
  INDEX `fk_distrito_departamento1_idx` (`iddepartamento` ASC) ,
  ...
  CONSTRAINT `fk_distrito_provincia1`
    ...
    REFERENCES `tesis_laban`.`provincia` (`id_provincia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS tesis_laban.persona (
  `id_persona` INT(11) NOT NULL AUTO_INCREMENT,
  `nombre` VARCHAR(60) NULL DEFAULT NULL,
  `apellido` VARCHAR(150) NULL DEFAULT NULL,
  `codigo_estudiante` VARCHAR(10) NULL DEFAULT NULL,
  ...
  `universidad` VARCHAR(60) NULL DEFAULT NULL,
  `carrera` VARCHAR(60) NULL DEFAULT NULL,
  `tipo_colegio` VARCHAR(15) NULL DEFAULT NULL,
  `iddepartamento` INT(11) NOT NULL,
  `idprovincia` INT(11) NOT NULL,
  `iddistrito` INT(11) NOT NULL,
  `fecha` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_persona`),
  INDEX `fk_persona_departamento1_idx` (`iddepartamento` ASC) ,
  ...
  CONSTRAINT `fk_persona_distrito1`
    ...
    REFERENCES `tesis_laban`.`distrito` (`id_distrito`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION
)ENGINE = InnoDB DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS tesis_laban.punto (
...
CREATE TABLE IF NOT EXISTS tesis_laban.pregunta (
...
CREATE TABLE IF NOT EXISTS tesis_laban.respuesta (
  ...
  INDEX `fk_respuesta_persona_idx` (`idpersona` ASC) ,
  INDEX `fk_respuesta_pregunta1_idx` (`idpregunta` ASC) ,
  INDEX `fk_respuesta_punto1_idx` (`idpunto` ASC) ,
  CONSTRAINT `fk_respuesta_persona`
    FOREIGN KEY (`idpersona`)
    REFERENCES `tesis_laban`.`persona` (`id_persona`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_respuesta_pregunta1`
    FOREIGN KEY (`idpregunta`)
    REFERENCES `tesis_laban`.`pregunta` (`id_pregunta`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_respuesta_punto1`
    FOREIGN KEY (`idpunto`)
    REFERENCES `tesis_laban`.`punto` (`id_punto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8; 

INSERT INTO tesis_laban.departamento (`id_departamento`, `nombre`) 
VALUES
('01', 'Amazonas'),
('02', 'Áncash'),
('03', 'Apurímac'),
...
INSERT INTO tesis_laban.provincia (`id_provincia`,`nombre`, `iddepartamento`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
INSERT INTO tesis_laban.distrito (`id_distrito`, `nombre`, `idprovincia`, `iddepartamento`) VALUES
...
INSERT INTO tesis_laban.pregunta(`nombre`)
VALUES 
('Me gusta divertirme'),
('Soy muy bueno (a) para comprender cómo la gente se sientse'),
...
('Sé como mantenerme tranquilo (a)'),
...
('Me agrada sonreír'),
('sIntento no herir los sentimientos de las personas'),
...
('Para mí es fácil decirle a las personas cómo me siento'),
('Cuando respondo preguntas difíciles trato de pensar en muchas soluciones'),
...
('Me gusta mi cuerpo'),
('Aún cuando las cosas sean difíciles, no me doy por vencido'),
('Cuando me molesto actúo sin pensar'),
('Sé cuando la gente está molesta aún cuando no dicen nada'),
('Me gusta la forma como me veo');

INSERT INTO tesis_laban.punto(`nombre`)
VALUES ('Muy rara vez'),('Rara vez'),('Menudo'),('Muy a menudo');
